...
export class NeventChatbotComponent implements AfterViewInit, OnDestroy {
  ...
  async ngAfterViewInit(): Promise<void> {
    const config: ChatbotConfig = {
      ...
      ...(this.autoOpenDelay !== undefined && {
        autoOpenDelay: this.autoOpenDelay,
      }),
      ...(this.persistConversation !== undefined && {
        persistConversation: this.persistConversation,
      }),
      ...(this.conversationTTL !== undefined && {
        conversationTTL: this.conversationTTL,
      }),
      ...(this.showBranding !== undefined && {
